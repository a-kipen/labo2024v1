...
Experimiento_id <- "_Exp17_ak_750" # Acá pongo el número de nuestro experimento
...
HT_tuning_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/Exp17_561_HT_lightgbm_700.r"   # Acá ajusto también el nombre del experimento
