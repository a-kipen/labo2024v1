...
PARAM <- list()
PARAM$experimento <- "KA4540_ak_lgbmBO"
...
PARAM$finalmodel$num_iterations <- 758
PARAM$finalmodel$learning_rate <- 0.0100108946238475
PARAM$finalmodel$feature_fraction <- 0.359835639901021
PARAM$finalmodel$min_data_in_leaf <- 746
